        ...
        if http_method == "GET":
            ...
            if c.silo.exists(id):
                ...
                while(mimetype):
                    if str(mimetype) in ["text/html", "text/xhtml"]:
                        f = open("/tmp/python_out.log", "a")
                        f.write("Output returned in text/html :\n %s \n"%str(render('/itemview.html')))
                        f.write('-'*40+'\n')
                        f.close()
                        ...
                        f = open("/tmp/python_out.log", "a")
                        f.write("Output returned in application/json : \n %s \n"%str(simplejson.dumps(items)))
                        f.write('-'*40+'\n')
                        f.close()
                        return simplejson.dumps(items)
                        ...
                        f = open("/tmp/python_out.log", "a")
                        f.write("Output returned in text/rdf_n3 (pretty-xml): \n %s \n"%str(c.item.rdf_to_string(format="n3")))
                        f.write('-'*40+'\n')
                        f.close()
                        ...
                        f = open("/tmp/python_out.log", "a")
                        f.write("Output returned in application/x-turtle: \n %s \n"%str(c.item.rdf_to_string(format="turtle")))
                        f.write('-'*40+'\n')
                        f.close()
                        ...
                        f = open("/tmp/python_out.log", "a")
                        f.write("Output returned in text/rdf+ntriples : \n %s \n"%str(c.item.rdf_to_string(format="nt")))
                        f.write('-'*40+'\n')
                        f.close()

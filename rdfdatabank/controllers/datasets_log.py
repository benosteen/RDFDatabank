...
class DatasetsController(BaseController):      
    ...
    def datasetview(self, silo, id):       
        ...
        if http_method == "GET":
            ...
            toc = time.mktime(time.gmtime())
            f.write("3. Embargo information: %d\n"%(toc-tic))
            f.close()
            ...
            toc = time.mktime(time.gmtime())
            f.write("4. Detailed file stats: %d\n"%(toc-tic))
            f.close()
